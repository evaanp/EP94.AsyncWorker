...
namespace EP94.AsyncWorker.Public.Interfaces
{
    ...
    {
        IWorkHandle Then(ActionWorkDelegate<TResult> task, ConfigureAction? configureAction = null, string? name = null);
        ...
        IWorkHandle<TNextResult> Then<TNextResult>(FuncWorkDelegate<TNextResult> task, ConfigureAction<TNextResult>? configureAction = null, string? name = null);
        ...
        IWorkHandle<TNextResult> Then<TNextResult>(FuncWorkDelegate<TResult, TNextResult> task, ConfigureAction<TNextResult>? configureAction = null, string? name = null);
